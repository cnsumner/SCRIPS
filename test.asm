...
entry:
LOAD 2 n 			//init reg[2] to n
ADDI 1 1 			//init reg[1] to 1

loop:
BZERO 2 endloop: 	//while n > 0
MOVE 3 0 			//reg[3] (newn) = 0
MOVE 4 1 			//i = 1
...
MOVE 6 4 				//if data[i-1] > data[i]
ADDI 6 nums1 			//.. (reg[6] = data address + offset i)
STORE 6 arg2 			//.. (arg2 = reg[6])
ADDI 6 -1 				//.. (reg[6] = reg[6] - 1)
STORE 6 arg1 			//.. (arg1 = reg[6])
LOADI 7 arg1 			//.. (reg[7] = data[i - 1])
LOADI 6 arg2 			//.. (reg[6] = data[i])
STORE 6 temp1 			//.. (temp1 = reg[6])
SGT 7 temp1 			//.. if (reg[7] > data[i])
BZERO 7 ifnot: 			//.. ..
